...
export const categories: Category[] = [
  {
    ...
    calculators: [
      ...
      { name: 'FHA Loan Calculator', href: '/calculators/fha-loan-calculator', description: 'FHA payment including MIP (mortgage insurance)', icon: '🏠', live: true },
      ...
      { name: 'Mutual Fund Calculator', href: '/calculators/mutual-fund-calculator', description: 'Future value with contributions and expense ratio', icon: '📊', live: true },
  ...
  },
  {
    ...
    calculators: [
      ...
      { name: 'Period Calculator', href: '/calculators/period-calculator', description: 'Predict your next period, ovulation & fertile window', icon: '📅', live: true },
  ...
  },
  {
    ...
    calculators: [
      ...
      { name: 'Stair Calculator', href: '/calculators/stair-calculator', description: 'Steps, riser height, tread depth & stringer length', icon: '🪜', live: true },
      ...
      { name: 'Molarity Calculator', href: '/calculators/molarity-calculator', description: 'Molar concentration from mass, molar mass & volume', icon: '🧪', live: true },
      ...
      { name: 'Horsepower Calculator', href: '/calculators/horsepower-calculator', description: 'HP from torque and RPM, with kW and PS', icon: '🏎️', live: true },
...
export const siloAssignments: Record<string, { silo: string; hub: string }> = {
  ...
  'fha-loan-calculator': { silo: 'loans', hub: 'Mortgage & Home' },
  ...
  'mutual-fund-calculator': { silo: 'invest', hub: 'Investing & Returns' },
  ...
  'stair-calculator': { silo: 'home', hub: 'Construction' },
  ...
  'horsepower-calculator': { silo: 'sci', hub: 'Physics & Space' },
  'molarity-calculator': { silo: 'sci', hub: 'Physics & Space' },
}
